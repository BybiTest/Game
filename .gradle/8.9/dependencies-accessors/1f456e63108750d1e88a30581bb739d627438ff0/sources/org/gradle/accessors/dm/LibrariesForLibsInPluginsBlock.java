...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final TapsellLibraryAccessors laccForTapsellLibraryAccessors = new TapsellLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>tapsell</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public TapsellLibraryAccessors getTapsell() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForTapsellLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class TapsellLibraryAccessors extends SubDependencyFactory {
        private final TapsellPlusLibraryAccessors laccForTapsellPlusLibraryAccessors = new TapsellPlusLibraryAccessors(owner);

        public TapsellLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>tapsell.plus</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public TapsellPlusLibraryAccessors getPlus() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForTapsellPlusLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class TapsellPlusLibraryAccessors extends SubDependencyFactory {

        public TapsellPlusLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>sdk</b> with <b>ir.tapsell.plus:tapsell-plus-sdk-android</b> coordinates and
         * with version reference <b>tapsellPlus</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getSdk() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("tapsell.plus.sdk");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>googleDevtoolsKsp</b> with value <b>2.0.21-1.0.28</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>tapsellPlus</b> with value <b>2.3.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getTapsellPlus() { return getVersion("tapsellPlus"); }
